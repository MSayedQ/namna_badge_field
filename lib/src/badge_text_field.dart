...
class BadgeTextField extends StatefulWidget {
  ...
  final Function(OptionData option) onClearOption;
  final Function(OptionData option) onSelectOption;
  final Future<List<OptionData>> Function(String s)? onChange;
...
class _OptionTextFieldWidget extends State<BadgeTextField> {
  List<OptionData> selectedOptions = [];
  List<OptionData> hintList = [];
  String? error;
  bool? loading;
                  ...
                  child: Wrap(
                    ...
                    children: [
                      ...selectedOptions.map((e) => Padding(
                          ...
                          child: formulaItem(listItem: e))),
                      _buildOptionTextField(context)
                    ],
                  ),
                ),
              )),
  ...
  Widget formulaItem({required OptionData listItem}) {
    return HoverBuilder(
      builder: (context, h) {
        return Container(
          decoration: BoxDecoration(
  ...
  Widget _buildOptionTextField(BuildContext context) {
    return SizedBox(
      height: 28,
      width: 100,
      child: TextFormField(
